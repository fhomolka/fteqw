...
typedef struct
{
	...
	F(int,		ReadUInt16,			(void));
	F(int,		ReadLong,			(void));
	F(qint64_t,	ReadInt64,			(void));
	F(quint64_t,ReadUInt64,			(void));
//	F(qint64_t,	ReadSLEB128,		(void));
	F(quint64_t,ReadULEB128,		(void));
	F(qint64_t,	ReadSignedQEX,		(void));
	F(unsigned int,	SVReadEntity,	(struct client_s *fromclient));
	F(unsigned int,	CLReadEntity,	(void));
	F(unsigned int,	ReadBigEntity,	(void));
	F(float,	ReadFloat,			(void));
	F(double,	ReadDouble,			(void));
	F(void,		ReadData,			(void *data, int len));
	F(char*,	ReadString,			(void));
	F(float,	ReadCoord,			(void));
	F(float,	ReadCoordFloat,		(void));
	F(float,	ReadAngle,			(void));
	F(float,	ReadAngle16,		(void));
	F(void,		ReadSkip,			(int len));

	F(void,		BeginWriting,		(sizebuf_t *sb, struct netprim_s prim, void *bufferstorage, size_t buffersize));
	F(void,		WriteChar,			(sizebuf_t *sb, int c));
	...
	F(void,		WriteInt64,			(sizebuf_t *sb, qint64_t c));
	F(void,		WriteUInt64,		(sizebuf_t *sb, quint64_t c));
	F(void,		WriteULEB128,		(sizebuf_t *sb, quint64_t c));
	F(void,		WriteSignedQEX,		(sizebuf_t *sb, qint64_t c));
	F(void,		WriteEntity,		(sizebuf_t *sb, unsigned int e));
	F(void,		WriteFloat,			(sizebuf_t *sb, float f));
	F(void,		WriteDouble,		(sizebuf_t *sb, double f));
	F(void,		WriteData,			(sizebuf_t *sb, const void *data, int len));
	F(void,		WriteString,		(sizebuf_t *sb, const char *s));
	F(void,		WriteCoord,			(sizebuf_t *sb, float f));
//	F(void,		WriteBigCoord,		(sizebuf_t *sb, float f));
	F(void,		WriteAngle,			(sizebuf_t *sb, float f));
	F(void,		WriteAngle8,		(sizebuf_t *sb, float f));
	F(void,		WriteAngle16,		(sizebuf_t *sb, float f));
	F(void,		WriteDir,			(sizebuf_t *sb, float *dir));
